...
var_dump($response);
if(!empty($response_parsed->data)){
    header("Refresh: 3; URL='$response_parsed->data'");
}
//echo $response_parsed;
...
if (!window.KTracking){window.KTracking={collectNonUniqueClicks: false, multiDomain: false, R_PATH: 'https://adv2click.com/zNnMs5', P_PATH:'https://adv2click.com/17ee657/postback', listeners: [], reportConversion: function(){this.queued = arguments;}, getSubId: function(fn) {this.listeners.push(fn);}, ready: function(fn) {this.listeners.push(fn);} };}(function(){var a=document.createElement('script');a.type='application/javascript';a.async=true;a.src='https://adv2click.com/js/k.min.js';var s=document.getElementsByTagName('script')[0];s.parentNode.insertBefore(a,s)})();


</script><noscript><img height='0' width='0' alt='' src='https://adv2click.com/zNnMs5'/></noscript>
                    ...
                    <div class="col-md-6">
                        <div class="register_form pt-3 pb-5">
                            <div class="form_heading">
                                <h3 class="all_h3">
                                    <span class="form_span">Thank you!</span>
                                </h3>
                                <p>We will contact you </p>
                            </div>
                            <?php if($_POST){ ?>
                            <form>
								<input type=hidden id ="first_name" name="first_name" value="<?php echo $_POST['fname'] ?>">
								<input type=hidden id ="last_name" name="last_name" value="<?php echo $_POST['lname'] ?>">
								<input type=hidden id ="phone" name="phone" value="<?php echo $_POST['phone'] ?>">
                                <input type=hidden id ="phone_code" name="phone_code" value="<?php echo $_POST['phone_code'] ?>">
								<input type=hidden id ="email" name="email" value="<?php echo $_POST['email'] ?>">
								<input type=hidden id ="user_ip" name="user_ip" value="<?php echo $_POST['user_ip'] ?>">
							</form>
							    ...
							    <script>
							            ...
							            KTracking.reportConversion(0, 'lead', {sub_id_1: first_name, sub_id_2: last_name, sub_id_3: phone_code + phone, sub_id_4: email, sub_id_5: user_ip})
							    </script>
                                <?php } ?>

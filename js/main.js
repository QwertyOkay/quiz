...
const quizdata=[
      ...
      {
        question:"Suppose you have got $100 in a investment funds account gaining 2 percent intrigued a year. After five years, how much would you have?",
        options:["More than $102", "Exactly $102", "Less than $102", "Don't Know"],
        answer:"More than $102",
        category:3
      },
      {
        question:"Envision that the intrigued rate on your reserve funds account is 1 percent a year and expansion is 2 percent a year. After one year, would the cash within the account purchase more than it does nowadays, precisely the same or less than nowadays?",
        options:["More", "Same", "Less", "Don't Know"],
        answer:"Less",
        category:2
      },
      {
        question:"On the off chance that intrigued rates rise, what will ordinarily happen to bond costs? Rise, drop, remain the same, or is there no relationship?",
        options:["Rise", "Fall", "Stay the Same", "Don't Know"],
        answer:"Fall",
        category:3
      },
      {
        question:"True or False: A 15-year contract ordinarily requires higher month to month installments than a 30-year contract but the overall intrigued over the life of the advance will be less.",
      ...
      {
        question:"Assume you owe $1,000 on a advance and the intrigued rate you're charged is 20% per year compounded yearly. On the off chance that you didn't pay anything off, at this intrigued rate, how numerous a long time would it take for the sum you owe to twofold?",
        options:["Less than 2 years", "2 to 4 years", "5 to 9 years", "10 or more years", "Don't Know"  ],
        answer:"2 to 4 years",
        category:3
      },
      {
        question:"Which of the taking after demonstrates the most noteworthy likelihood of getting a specific disease?",
        options:["There is a one-in-twenty chance", "2% of the population", "25 out of every 1,000 ", "Don't Know"],
        answer:"There is a one-in-twenty chance",
        category:1
      }
    ];
